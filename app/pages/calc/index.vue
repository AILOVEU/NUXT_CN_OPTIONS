      ...
      <div class="mx-auto bg-white rounded-xl shadow-md p-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-1 mb-1">
          <div class="flex flex-col gap-1">
            ...
            <el-input-number
              v-model="params.daysToExpire"
              :min="0"
              :disabled="selectedAxis === 'days'"
              @change="calcOption"
              class="w-full"
            />
          </div>
          ...
          <div class="flex flex-col gap-1">
            ...
            <el-input-number
              v-model="params.spotPrice"
              step="0.01"
              :min="0.01"
              :disabled="selectedAxis === 'spot'"
              @change="calcOption"
              class="w-full"
            />
          </div>
          <div class="flex flex-col gap-1">
            ...
            <el-input-number
              v-model="params.impliedVol"
              step="0.1"
              :min="0.01"
              :disabled="selectedAxis === 'vol'"
              @change="calcOption"
              class="w-full"
            />
          </div>
