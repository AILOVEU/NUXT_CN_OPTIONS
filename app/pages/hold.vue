<template>
  <div v-loading="tableData.loading || globalLoading.value" :style="{ width: isMobile && mode === 'hold' ? '250%' : '100%' }">
    <!-- {{tableData.data}} -->
    <div>
      <Nav v-if="mode === 'hold'" />
    ...
    <div class="h-[calc(100vh-80px)] max-md:h-[calc(250vh-85px)] flex justify-center">
