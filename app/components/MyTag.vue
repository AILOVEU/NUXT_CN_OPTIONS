<template>
  <span class="my-tag my-tag-wrapper whitespace-nowrap inline-block px-[3px] pt-[1px] pb-[4px] rounded-md font-black text-[14px]" :style="wrapperStyle" v-if="props.label || isValidVal">
